...
/**
 * Сколько ростовок показывать без раскрытия — так решил владелец: страница
 * должна открываться коротким списком, а не полотном на два экрана.
 *
 * Три строки идут в обычном порядке цветка (у розы это 40, 50, 60), поэтому
 * крупный мини-микс может оказаться под кнопкой. Это осознанно: порядок длин
 * важнее, чем то, какая строка сегодня самая большая, а полное количество по
 * цветку всё равно стоит в заголовке блока.
 */
