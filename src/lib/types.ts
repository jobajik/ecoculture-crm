...
export interface Client {
  ...
  paymentMethod: string;
  /** Наш Kaspi Pay для розы и эустомы — счёт Rose Farm. Вписывается свободно. */
  kaspiRoseFarm: string;
  /** Наш Kaspi Pay для хризантемы — счёт Есентай Агро Хим. */
  kaspiEsentai: string;
  /** Каспи самого клиента: по нему бухгалтер узнаёт входящий перевод. */
  kaspiClient: string;
}
