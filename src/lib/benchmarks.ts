...
export const BENCHMARKS = {
  ...
  /**
   * Сколько дней прайс не меняли. Меньше — лучше: цветок — товар с ценой,
   * которая ходит вслед за сезоном, и прайс, которому полтора месяца, перестаёт
   * быть ориентиром — отклонение от него уже ничего не значит.
   */
  priceListAgeDays: { good: 14, warn: 30 },
  /**
   * Какая доля выручки вообще сравнима с прайсом, %. Больше — лучше: если цена
   * задана только у трети позиций, «скидка 2 %» посчитана по трети продаж.
   */
  pricedRevenuePercent: { good: 90, warn: 70 },
