  ...
  theme: {
    extend: {
      colors: {
        ...
        // Цвет РАЗДЕЛА карточки: полоска слева и значок в заголовке, чтобы
        // клиент, позиции, деньги и претензии различались с первого взгляда, а
        // не сливались в одинаковые белые прямоугольники. Деньги красятся по
        // СОСТОЯНИЮ (status.good / warning / critical), остальные — по смыслу.
        section: {
          client: "#2f6fd6",
          "client-soft": "#eaf1fc",
          stock: "#7b5bd6",
      ...
      fontFamily: {
        ...
        // Для «лица» документа — номер заявки, имя клиента, крупные суммы.
        // Владелец: «на заказ использовать специальный шрифт и оформление».
        // Manrope — с кириллицей, самохостится пакетом (грабли 1.4).
        display: ["Manrope", "Arimo", "Helvetica Neue", "Arial", "sans-serif"],
      },
      borderRadius: {
        xl: "14px",
        "2xl": "18px",
